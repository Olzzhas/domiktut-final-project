...
import { IDataManager, ILineStringGeometry, IPolylineOptions } from 'yandex-maps';
...
export declare const Polyline: React.FC<React.PropsWithChildren<PolylineProps & WithYMapsProps & WithInstanceRef & ErrorBoundaryProps & AnyObject>>;
declare const _default: React.FC<React.PropsWithChildren<PolylineProps & WithYMapsProps & WithInstanceRef & ErrorBoundaryProps & AnyObject>>;
